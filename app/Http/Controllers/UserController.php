...
use App\Traits\{CaptureIpTrait, CastRequestTrait};
...
class UserController extends Controller
{
    ...
    public function index(Request $request, User $user)
    {
        try {
            ...
            $newQuery = $user->fromSub($subQuery, 'users');
            /*filter*/
            /*get pagination*/
            ...
            $collection->map(function ($item, $key) {
                ...
                $roleName = array_map(function($role){return __('app.'.$role['name']??'');}, $item->roles->toArray());
                $item->__set('role', implode(', ', $roleName));
            });
            // exit();
            /*export list*/
            if ($action === 'export') {
            ...
            return view('layouts.default')->with(['view' => view('users.index')->with([
    ...
    */
    public function exportList($collection = [], $customHeading = [])
    {
        try {
            ...
            $fileName = 'user-list-'. $nowString . '.xlsx';
