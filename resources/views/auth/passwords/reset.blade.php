...
@section('css')
    @parent
    <style>
        #reset-password-form input {max-width: 400px;}
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header text-uppercase h4 text-sm-center pb-0 ">{{ trans('titles.resetPword') }}<hr></div>
                <div class="card-body">
                    <div class="card-block pt-0">
                        ...
                        @endif
                        <form method="POST" id="reset-password-form" action="{{ route('password.request') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ trans('app.confirm-password') }}</label>
                                <div class="col-md-6">
