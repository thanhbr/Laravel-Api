            ...
            <div class="card">
                      ...
                      <div class="row">
                        <div class="col-xl-8 col-lg-8 col-sm-12 mb-1">
                          ...
                          <fieldset class="form-group mb-0 {{$class_fieldset}}">
                            ...
                            <input type="text" name="name" class="form-control {{$class_NameTag}}" placeholder="Name" value="{{old('name')}}">
                ...
                <div class="card-footer">
                  <div>
                    ...
                    <button type="submit" class="btn btn-success btn-add"> {{__('app.create')}}</button>
                  </div>
                </div>
            </div>
        </div>
