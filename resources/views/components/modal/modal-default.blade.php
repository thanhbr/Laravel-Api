...
@endphp
<style type="text/css">
  /*.utility .modal{z-index: 1200!important;position: relative!important;}  */
  /*#modal-default .modal-content{width: auto;}*/
  /*#modal-default .modal-dialog{position: fixed;z-index: 1050;  }*/
  /*#modal-default .modal-body{padding: 0px;}*/
  /*fixed*/
  ...
  /*
  #modal-default.modal-sm .modal-content{max-width: 500px}
  #modal-default.modal-md .modal-content{max-width: 800px}
  #modal-default.modal-lg .modal-content{max-width: 1200px}*/
</style>
<div class="utility">
...
<script type="text/javascript">
    ...
    // btnPost.on("touchstart", function (e) {
    //   let getURL = $(this).attr('href');
    //     console.log(e);
    //     e.preventDefault();
    // });
