...
@endphp
<style type="text/css">
  table.datatable thead tr th.th-no,
  table.datatable tbody tr td.td-no {max-width: 30px!important;padding-right:7px!important;padding-left:7px!important;}
  table.datatable tbody tr td >div.lbl-description{max-height: 100px;overflow-y: auto;}
  table.datatable tbody tr td.td-description{min-width: 300px}
  /*customize*/
